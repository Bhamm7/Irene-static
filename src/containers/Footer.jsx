...
export default () => (
    <footer className="flex-rw">
        ...
        <ul className="footer-list-top">
            ...
            <li><a href='/Ladies-Accessories/cat/id/117' className="generic-anchor footer-list-anchor">HANDBAGS & JEWELRY</a></li>
        </ul>
        <ul className="footer-list-top">
            <li id='help'>
        ...
        <section className="footer-social-section flex-rw">
            ...
            <a href="https://www.pinterest.com/paviliongift/" className="generic-anchor" title="Pinterest"><i className="fa fa-pinterest"></i></a>
            <a href="https://www.facebook.com/paviliongift" className="generic-anchor" title="Facebook"><i className="fa fa-facebook"></i></a>
            <a href="https://twitter.com/PavilionGiftCo" className="generic-anchor" title="Twitter"><i className="fa fa-twitter"></i></a>
            <a href="http://instagram.com/paviliongiftcompany" className="generic-anchor" title="Instagram"><i className="fa fa-instagram"></i></a>
            <a href="https://www.youtube.com/channel/UCYgUODvd0qXbu_LkUWpTVEg" className="generic-anchor" title="Youtube"><i className="fa fa-youtube"></i></a>
            <a href="https://plus.google.com/+Paviliongift/posts" className="generic-anchor" title="Google Plus"><i className="fa fa-google-plus"></i></a>
            </span>
        </section>
